...
export const buttons = [
  ...
  },
  {
    ...
    component: (
      <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
        ...
        <span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-emerald-400/0 via-blue-400/90 to-emerald-400/0 transition-opacity duration-500 group-hover:opacity-40"></span>
      </button>
    ),
  },
  {
  ...
  {
    name: "Component UI",
    description: "Component UI button with perfect corners",
    component: (
      <button className="px-8 py-2 border border-black bg-transparent text-black  dark:border-white relative group transition duration-200">
        <div className="absolute -bottom-2 -right-2 bg-indigo-300 h-full w-full -z-10 group-hover:bottom-0 group-hover:right-0 transition-all duration-200" />
        <span className="relative">Component UI</span>
      </button>
    ),
  },
  {
  ...
  },
  {
    ...
    description: "Component UI",
    component: (
      <button className="px-12 py-4 rounded-full bg-[#50a3f6] font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-[#f47070] transition-colors duration-200">
       UI
      </button>
    ),
  },
  ...
  },
  {
    ...
    component: (
      <button className="px-8 py-2 rounded-full relative bg-slate-900 text-white text-sm hover:shadow-2xl hover:shadow-white/[0.1] transition duration-200 border border-slate-600">
        ...
        <span className="relative z-20">Component UI</span>
      </button>
    ),
  },
];
